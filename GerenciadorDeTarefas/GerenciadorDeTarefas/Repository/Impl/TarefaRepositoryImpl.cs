...
namespace GerenciadorDeTarefas.Repository.Impl
{
    public class TarefaRepositoryImpl : ITarefaRepository
    {
        ...
        {
            _contexto.Tarefa.Add(tarefa); //achei a tabela e salvei
        ...
        public List<Tarefa> BuscarTarefas(int idUsuario, DateTime? periodoDe, DateTime? periadoAte, StatusTarefaEnum status)
        {
            return _contexto.Tarefa.Where(tarefa => tarefa.IdUsuario == idUsuario
                    ...
                    && (periadoAte == null || periadoAte == DateTime.MinValue || tarefa.DataPrevistaConclusao <= ((DateTime)periadoAte).Date)
